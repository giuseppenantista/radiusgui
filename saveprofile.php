...
<?php
        ...
        // La pagina editprofile.php mi ha passato i campi profilename,down,up,priority
        ...
        mysql_query("UPDATE profiles set down='$down',up='$up',priority='$priority' where profilename='$profilename'");
