...
<?php
        ...
        $dd=mysql_query("SELECT address from ip where pool='BLOCCATI' and used=0");
        ...
        mysql_query("UPDATE ip set used=1 where address='$d[0]'");
        mysql_query("UPDATE userinfo set attivato='0' where UserName='$UserName'");
